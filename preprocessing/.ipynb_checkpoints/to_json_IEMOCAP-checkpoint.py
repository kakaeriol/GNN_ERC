...
def create_json_file(base_IEMOCAP_link, base_output):
    ...
    for session in all_sessions:
        ...
        print(session, path_to_label, path_to_sentence)
        ...
        for s, l in zip(sentence_files, label_files):
            i_sp = os.path.join(sentence_path.format(session), "{}".format(s))
            i_lp = os.path.join(label_path.format(session), "{}".format(l))
