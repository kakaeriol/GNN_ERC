...
class myRGCNConv(MessagePassing):
    ...
    def forward(self, x: Union[OptTensor, Tuple[OptTensor, Tensor]],
                    edge_index: Adj, edge_type: OptTensor = None, edge_norm: OptTensor = None,):
            ...
            if self.num_blocks is not None:  # Block-diagonal-decomposition =====
                ...
                for i in range(self.num_relations):
                    ...
                    h = self.propagate(tmp, x=x_l, edge_type_ptr=None, size=size, edge_norm=edge_norm)
    ...
    def message(self, x_j: Tensor, edge_type_ptr: OptTensor, edge_norm: OptTensor) -> Tensor:
